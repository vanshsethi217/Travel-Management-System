...
//     Login()
//     {//System.out.println("Login constructor starting...");
...
//         setVisible(true);
//         //System.out.println("Login constructor finished!");
...
public class Login extends JFrame implements ActionListener 
{
    ...
    JPasswordField tfpassword;   // <-- IMPORTANT CHANGE
    ...
    Login() 
    {
        ...
        tfpassword.setBounds(60, 150, 300, 30);
        tfpassword.setBorder(BorderFactory.createEmptyBorder());
        tfpassword.setEchoChar('•');  // <-- Shows bullets instead of characters
        p2.add(tfpassword);
    ...
    public void actionPerformed(ActionEvent ae) 
    {
        ...
        if (ae.getSource() == login) 
        {
            try 
            {
                ...
                // 🔥 JPasswordField returns char[] → So convert properly
